...
const ViewAllRemark = () => {
  ...
  const fetchRemarks = async () => {
    try {
      const response = await axios.get(`https://crm-generalize.dentalguru.software/api/remarks/${id}`,
        {
          headers: {
  ...
  const handleDelete = async (remark) => {
    ...
    try {
      // Delete the remark
      const deleteResponse = await axios.delete(`https://crm-generalize.dentalguru.software/api/remarks/${remark.id}`);
  ...
  const updateRemark = async () => {
    try {
      const response = await axios.put(`https://crm-generalize.dentalguru.software/api/remarks`, modalData);
