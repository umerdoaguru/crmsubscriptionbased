...
const QuotationInputForm = ({name}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://crm-generalize.dentalguru.software/api/quotation-information-form", dataToSubmit);
      ...
      try {
        const updateResponse = await axios.put(
          `https://crm-generalize.dentalguru.software/api/updateOnlyQuotationStatus/${id}`,
          { quotation: "created" }
        );
