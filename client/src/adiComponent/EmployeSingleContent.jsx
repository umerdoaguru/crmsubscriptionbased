...
const EmployeeSingleContent = () => {
  ...
  const fetchEmployee = async () => {
    try {
      const response = await axios.get(
        `https://crm-generalize.dentalguru.software/api/getEmployeeById/${employeeId}`,
        {
          headers: {
  ...
  const isPhoneNumberTaken = async (phone) => {
    try {
      const response = await axios.get(
        "https://crm-generalize.dentalguru.software/api/checkPhoneNumber",
        {
          params: { phone },
        }
      );
    ...
    try {
      ...
      if (editingIndex !== null) {
        response = await axios.put(
          `https://crm-generalize.dentalguru.software/api/updateSingleEmployee/${employee.employeeId}`,
          formData,
          {
  ...
  const handleDeleteEmployee = async () => {
    if (employee) {
      ...
      if (isConfirmed) {
        try {
          await axios.delete(
            `https://crm-generalize.dentalguru.software/api/deleteEmployee/${employee.employeeId}`
          );
                  ...
                  <div className="p-6 bg-white rounded-lg shadow-md">
                    ...
                    <div className="flex justify-end space-x-4">
                      <button
                        ...
                        className={`px-4 py-2 text-white flex items-center gap-1 rounded-lg shadow-lg ${
                          employee
...
export default EmployeeSingleContent;
