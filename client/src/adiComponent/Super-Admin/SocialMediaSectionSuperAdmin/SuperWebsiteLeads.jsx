  ...
  const fetchLeads = async () => {
    try {
      const response = await axios.get(
        "https://crm-generalize.dentalguru.software/api/user-data-super-admin",
        {
          headers: {
  ...
  return (
    <>
      <div className="container">
        <h2 className="text-2xl text-center mt-[2rem]">Website Leads Data</h2>
