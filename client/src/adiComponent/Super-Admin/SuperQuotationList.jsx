...
const SuperQuotationList = () => {
    ...
    const fetchQuotations = async () => {
      try {
        const response = await axios.get(
          `https://crm-generalize.dentalguru.software/api/quotation-data-super-admin`,
          {
            headers: {
  ...
  const handleStatusChange = async (e, index, id) => {
    ...
    try {
      await axios.post(
        `https://crm-generalize.dentalguru.software/api/update-quotation-status`,
        {
          id: id,
          status: newStatus,
        },
