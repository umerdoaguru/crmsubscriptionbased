...
const uniqueYears = [
  ...
  const fetchProjects = async () => {
    try {
      const { data } = await axios.get(`https://crm-generalize.dentalguru.software/api/super-admin-all-project/${userId}`,
        {
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${token}`
  ...
  const fetchProjectsUnit = async (main_project_id) => {
    try {
        ...
        const response = await axios.get(`https://crm-generalize.dentalguru.software/api/super-admin-project-unit/${main_project_id}`,
          {
            headers: {
              'Content-Type': 'application/json',
              'Authorization': `Bearer ${token}`
  ...
  const updateAnswerRemark = async () => {
    try {
      const response = await axios.put(`https://crm-generalize.dentalguru.software/api/updateOnlyAnswerRemark`, modalData);
  ...
  if (validateForm()) {
    ...
    try {
      ...
      if (isEditing) {
        ...
        // Create new lead
        await axios.post("https://crm-generalize.dentalguru.software/api/leads", leadData);
